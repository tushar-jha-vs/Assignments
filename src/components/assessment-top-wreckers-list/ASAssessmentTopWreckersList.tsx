...
import { ASSESSMENT_SCREEN_IMAGE, ResizeMode, PROGRESS_LIST_BASE_URL } from '../../constants'
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.bottomContainer} onPress={() => setWebViewVisible(true)}>
        <Modal
          ...
          <WebView
            source={{
              uri: 'https://www.forbes.com/sites/mayarichard-craven/2023/08/24/how-to-deal-with-toxic-people-in-professional-settings/?sh=130974616d78',
            }}
          />
        </Modal>
